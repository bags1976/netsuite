namespace Netsuite.Dto
{
    ...
    public partial class CouponCodeSearchAdvanced : SearchRecord {

        private CouponCodeSearch criteriaField;

        private CouponCodeSearchRow columnsField;
        ...
        /// <remarks/>
        public CouponCodeSearch criteria {
            get {
        ...
        /// <remarks/>
        public CouponCodeSearchRow columns {
            get {
