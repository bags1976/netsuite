namespace Netsuite.Dto
{
    ...
    public partial class ItemSupplyPlanSearchAdvanced : SearchRecord {

        private ItemSupplyPlanSearch criteriaField;

        private ItemSupplyPlanSearchRow columnsField;
        ...
        /// <remarks/>
        public ItemSupplyPlanSearch criteria {
            get {
        ...
        /// <remarks/>
        public ItemSupplyPlanSearchRow columns {
            get {
