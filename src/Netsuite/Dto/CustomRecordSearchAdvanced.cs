namespace Netsuite.Dto
{
    ...
    public partial class CustomRecordSearchAdvanced : SearchRecord {

        private CustomRecordSearch criteriaField;

        private CustomRecordSearchRow columnsField;
        ...
        /// <remarks/>
        public CustomRecordSearch criteria {
            get {
        ...
        /// <remarks/>
        public CustomRecordSearchRow columns {
            get {
