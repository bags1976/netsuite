namespace Netsuite.Dto
{
    ...
    public partial class PriceLevelSearchAdvanced : SearchRecord {

        private PriceLevelSearch criteriaField;

        private PriceLevelSearchRow columnsField;
        ...
        /// <remarks/>
        public PriceLevelSearch criteria {
            get {
        ...
        /// <remarks/>
        public PriceLevelSearchRow columns {
            get {
