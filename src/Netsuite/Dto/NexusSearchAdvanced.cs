namespace Netsuite.Dto
{
    ...
    public partial class NexusSearchAdvanced : SearchRecord {

        private NexusSearch criteriaField;

        private NexusSearchRow columnsField;
