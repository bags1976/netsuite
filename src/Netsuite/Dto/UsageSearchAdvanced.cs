namespace Netsuite.Dto
{
    ...
    public partial class UsageSearchAdvanced : SearchRecord {

        private UsageSearch criteriaField;

        private UsageSearchRow columnsField;
