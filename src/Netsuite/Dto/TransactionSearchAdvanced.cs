namespace Netsuite.Dto
{
    ...
    public partial class TransactionSearchAdvanced : SearchRecord {

        private TransactionSearch criteriaField;

        private TransactionSearchRow columnsField;
        ...
        /// <remarks/>
        public TransactionSearch criteria {
            get {
        ...
        /// <remarks/>
        public TransactionSearchRow columns {
            get {
