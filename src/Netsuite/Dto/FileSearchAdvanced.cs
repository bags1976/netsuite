namespace Netsuite.Dto
{
    ...
    public partial class FileSearchAdvanced : SearchRecord {

        private FileSearch criteriaField;

        private FileSearchRow columnsField;
