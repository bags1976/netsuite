namespace Netsuite.Dto
{
    ...
    public partial class BomRevisionSearchAdvanced : SearchRecord {

        private BomRevisionSearch criteriaField;

        private BomRevisionSearchRow columnsField;
        ...
        /// <remarks/>
        public BomRevisionSearch criteria {
            get {
        ...
        /// <remarks/>
        public BomRevisionSearchRow columns {
            get {
