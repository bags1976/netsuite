namespace Netsuite.Dto
{
    ...
    public partial class CustomerMessageSearchAdvanced : SearchRecord {

        private CustomerMessageSearch criteriaField;

        private CustomerMessageSearchRow columnsField;
        ...
        /// <remarks/>
        public CustomerMessageSearch criteria {
            get {
        ...
        /// <remarks/>
        public CustomerMessageSearchRow columns {
            get {
