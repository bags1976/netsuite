namespace Netsuite.Dto
{
    ...
    public partial class CalendarEventSearchAdvanced : SearchRecord {

        private CalendarEventSearch criteriaField;

        private CalendarEventSearchRow columnsField;
        ...
        /// <remarks/>
        public CalendarEventSearch criteria {
            get {
        ...
        /// <remarks/>
        public CalendarEventSearchRow columns {
            get {
