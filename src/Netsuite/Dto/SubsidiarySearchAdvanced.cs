namespace Netsuite.Dto
{
    ...
    public partial class SubsidiarySearchAdvanced : SearchRecord {

        private SubsidiarySearch criteriaField;

        private SubsidiarySearchRow columnsField;
        ...
        /// <remarks/>
        public SubsidiarySearch criteria {
            get {
        ...
        /// <remarks/>
        public SubsidiarySearchRow columns {
            get {
