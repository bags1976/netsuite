namespace Netsuite.Dto
{
    ...
    public partial class TermSearchAdvanced : SearchRecord {

        private TermSearch criteriaField;

        private TermSearchRow columnsField;
