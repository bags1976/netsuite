namespace Netsuite.Dto
{
    ...
    public partial class PaymentOptionSearchAdvanced : SearchRecord {

        private PaymentOptionSearch criteriaField;

        private PaymentOptionSearchRow columnsField;
        ...
        /// <remarks/>
        public PaymentOptionSearch criteria {
            get {
        ...
        /// <remarks/>
        public PaymentOptionSearchRow columns {
            get {
