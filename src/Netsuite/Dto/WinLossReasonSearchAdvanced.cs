namespace Netsuite.Dto
{
    ...
    public partial class WinLossReasonSearchAdvanced : SearchRecord {

        private WinLossReasonSearch criteriaField;

        private WinLossReasonSearchRow columnsField;
        ...
        /// <remarks/>
        public WinLossReasonSearch criteria {
            get {
        ...
        /// <remarks/>
        public WinLossReasonSearchRow columns {
            get {
