namespace Netsuite.Dto
{
    ...
    public partial class EntityGroupSearchAdvanced : SearchRecord {

        private EntityGroupSearch criteriaField;

        private EntityGroupSearchRow columnsField;
        ...
        /// <remarks/>
        public EntityGroupSearch criteria {
            get {
        ...
        /// <remarks/>
        public EntityGroupSearchRow columns {
            get {
