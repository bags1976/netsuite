namespace Netsuite.Dto
{
    ...
    public partial class InboundShipmentSearchAdvanced : SearchRecord {

        private InboundShipmentSearch criteriaField;

        private InboundShipmentSearchRow columnsField;
        ...
        /// <remarks/>
        public InboundShipmentSearch criteria {
            get {
        ...
        /// <remarks/>
        public InboundShipmentSearchRow columns {
            get {
