namespace Netsuite.Dto
{
    ...
    public partial class PricingGroupSearchAdvanced : SearchRecord {

        private PricingGroupSearch criteriaField;

        private PricingGroupSearchRow columnsField;
        ...
        /// <remarks/>
        public PricingGroupSearch criteria {
            get {
        ...
        /// <remarks/>
        public PricingGroupSearchRow columns {
            get {
