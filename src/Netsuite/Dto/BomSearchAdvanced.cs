namespace Netsuite.Dto
{
    ...
    public partial class BomSearchAdvanced : SearchRecord {

        private BomSearch criteriaField;

        private BomSearchRow columnsField;
