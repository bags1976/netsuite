namespace Netsuite.Dto
{
    ...
    public partial class SalesTaxItemSearchAdvanced : SearchRecord {

        private SalesTaxItemSearch criteriaField;

        private SalesTaxItemSearchRow columnsField;
        ...
        /// <remarks/>
        public SalesTaxItemSearch criteria {
            get {
        ...
        /// <remarks/>
        public SalesTaxItemSearchRow columns {
            get {
