namespace Netsuite.Dto
{
    ...
    public partial class ContactCategorySearchAdvanced : SearchRecord {

        private ContactCategorySearch criteriaField;

        private ContactCategorySearchRow columnsField;
        ...
        /// <remarks/>
        public ContactCategorySearch criteria {
            get {
        ...
        /// <remarks/>
        public ContactCategorySearchRow columns {
            get {
