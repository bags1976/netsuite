...
namespace Netsuite.Dto
{
    ...
    public partial class LotNumberedInventoryItemLocations {
        ...
        private RecordRef locationlookupField;

        private string location_displayField;
        ...
        /// <remarks/>
        public RecordRef locationlookup {
            get {
                return this.locationlookupField;
            }
            set {
                this.locationlookupField = value;
            }
        }

        /// <remarks/>
        public string location_display {
            get {
                return this.location_displayField;
            }
            set {
                this.location_displayField = value;
            }
        }
