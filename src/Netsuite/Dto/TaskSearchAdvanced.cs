namespace Netsuite.Dto
{
    ...
    public partial class TaskSearchAdvanced : SearchRecord {

        private TaskSearch criteriaField;

        private TaskSearchRow columnsField;
