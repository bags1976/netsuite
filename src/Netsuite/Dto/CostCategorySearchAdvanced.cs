namespace Netsuite.Dto
{
    ...
    public partial class CostCategorySearchAdvanced : SearchRecord {

        private CostCategorySearch criteriaField;

        private CostCategorySearchRow columnsField;
        ...
        /// <remarks/>
        public CostCategorySearch criteria {
            get {
        ...
        /// <remarks/>
        public CostCategorySearchRow columns {
            get {
