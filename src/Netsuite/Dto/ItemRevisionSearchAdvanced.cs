namespace Netsuite.Dto
{
    ...
    public partial class ItemRevisionSearchAdvanced : SearchRecord {

        private ItemRevisionSearch criteriaField;

        private ItemRevisionSearchRow columnsField;
        ...
        /// <remarks/>
        public ItemRevisionSearch criteria {
            get {
        ...
        /// <remarks/>
        public ItemRevisionSearchRow columns {
            get {
