namespace Netsuite.Dto
{
    ...
    public partial class VendorReturnAuthorizationExpenseList {

        private VendorReturnAuthorizationExpense[] expenseField;
        ...
        public VendorReturnAuthorizationExpense[] expense {
            get {
