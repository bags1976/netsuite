namespace Netsuite.Dto
{
    ...
    public partial class ExpenseCategorySearchAdvanced : SearchRecord {

        private ExpenseCategorySearch criteriaField;

        private ExpenseCategorySearchRow columnsField;
        ...
        /// <remarks/>
        public ExpenseCategorySearch criteria {
            get {
        ...
        /// <remarks/>
        public ExpenseCategorySearchRow columns {
            get {
