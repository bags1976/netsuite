namespace Netsuite.Dto
{
    ...
    public partial class ItemSearchAdvanced : SearchRecord {

        private ItemSearch criteriaField;

        private ItemSearchRow columnsField;
