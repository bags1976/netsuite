namespace Netsuite.Dto
{
    ...
    public partial class PaymentMethodSearchAdvanced : SearchRecord {

        private PaymentMethodSearch criteriaField;

        private PaymentMethodSearchRow columnsField;
        ...
        /// <remarks/>
        public PaymentMethodSearch criteria {
            get {
        ...
        /// <remarks/>
        public PaymentMethodSearchRow columns {
            get {
