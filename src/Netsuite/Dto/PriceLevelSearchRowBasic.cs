namespace Netsuite.Dto
{
    ...
    public partial class PriceLevelSearchRowBasic : SearchRowBasic {

        private SearchColumnDoubleField[] discountPctField;
        ...
        public SearchColumnDoubleField[] discountPct {
            get {
