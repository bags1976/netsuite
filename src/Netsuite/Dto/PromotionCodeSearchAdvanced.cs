namespace Netsuite.Dto
{
    ...
    public partial class PromotionCodeSearchAdvanced : SearchRecord {

        private PromotionCodeSearch criteriaField;

        private PromotionCodeSearchRow columnsField;
        ...
        /// <remarks/>
        public PromotionCodeSearch criteria {
            get {
        ...
        /// <remarks/>
        public PromotionCodeSearchRow columns {
            get {
