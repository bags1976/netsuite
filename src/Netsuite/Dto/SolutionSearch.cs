namespace Netsuite.Dto
{
    ...
    public partial class SolutionSearch : SearchRecord {

        private SolutionSearchBasic basicField;

        private SupportCaseSearchBasic caseJoinField;

        private SolutionSearchBasic relatedSolutionJoinField;

        private TopicSearchBasic topicJoinField;
        ...
        /// <remarks/>
        public SolutionSearchBasic basic {
            get {
        ...
        /// <remarks/>
        public SolutionSearchBasic relatedSolutionJoin {
            get {
        ...
        /// <remarks/>
        public TopicSearchBasic topicJoin {
            get {
