namespace Netsuite.Dto
{
    ...
    public partial class VendorCategorySearchAdvanced : SearchRecord {

        private VendorCategorySearch criteriaField;

        private VendorCategorySearchRow columnsField;
        ...
        /// <remarks/>
        public VendorCategorySearch criteria {
            get {
        ...
        /// <remarks/>
        public VendorCategorySearchRow columns {
            get {
